...
def init_model():
    ...
    parser.add_argument("--method", type=str, default='GeoID',
    ...
    parser.add_argument("--num_pretrain_epochs", default=50, type=float,
                        help="The pre-training epochs.")  ###no extern--150 extern --100

    parser.add_argument("--num_train_epochs", default=100, type=float,
                        help="The training epochs.")
    
    parser.add_argument("--num_warm_epochs", default=20, type=float,
                        help="The training epochs.")
    ...
    parser.add_argument("--lambda_v", default=3, type=float, help="The ratio of labeled samples in the training set.")
