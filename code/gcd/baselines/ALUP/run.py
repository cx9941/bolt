...
def parse_arguments():
    ...
    parser.add_argument("--num_train_epochs", default=None, type=int, 
                        help="Override number of training epochs in config file.")
    
    parser.add_argument("--num_pretrain_epochs", default=None, type=int, 
                        help="Override number of pre-training epochs in config file.")
