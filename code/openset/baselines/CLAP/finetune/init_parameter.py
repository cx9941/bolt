...
def init_model():
    ...
    parser.add_argument("--kccl_k", default=5, type=int, help="The k value of KCCL")
    ...
    parser.add_argument("--KCCL_LOSS_LAMBDA", default=0.25, type=float, help="The temperature value of KCCL")

    parser.add_argument("--CE_LOSS_LAMBDA", default=0.75, type=float, help="The temperature value of KCCL")

    parser.add_argument("--LMCL_LOSS_LAMBDA", default=1.0, type=float, help="The temperature value of LMCL")

    parser.add_argument("--metric_type", default=1, type=int, help="The metric_type of train: 0-euc, 1-cos")
    ...
    parser.add_argument("--ks", default=1, type=float, help="The s value of KCCL")

    parser.add_argument("--km", default=0, type=float, help="The margin value of KCCL")

    parser.add_argument("--s_v", default=1, type=float, help="The s value of LMCL")

    parser.add_argument("--m", default=0, type=float, help="The margin value of LMCL")

    parser.add_argument("--c_m", default=2, type=float, help="The margin value of Contrastive Loss")
    ...
    parser.add_argument("--neg_method", default=3, type=int,
                        help="The method of neg example: ")

    parser.add_argument("--centroids", default=1, type=int,
    ...
    parser.add_argument("--model_type", default='1.1', type=str, help="The method of model")
    ...
    parser.add_argument("--softplus", default=0, type=int, help="The method of whether use softplus or not")
    ...
    parser.add_argument('--save_path_suffix', type=str, default='cos', help="the version suffix of the adbes save model")

    parser.add_argument('--eval_metric', type=str, default='f1', help="the eval_metric of the adbes save model: acc: accuracy, f1: f1-score")
    ...
    parser.add_argument("--num_pretrain_epochs", default=1, type=float, help="Total number of pretraining epochs to perform.")
