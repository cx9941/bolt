...
def init_model():
    ...
    parser.add_argument("--bert_model", default="../../llms/bert-base-uncased", type=str, help="The path for the pre-trained bert model.")
    ...
    parser.add_argument("--freeze_bert_parameters", default=True, type=bool, help="Freeze the last parameters of BERT")
